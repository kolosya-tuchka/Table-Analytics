...
#include <memory>
#include "../../Analytics/Timeline/Track.h"
...
QT_MOC_LITERAL(1, 6, 27), // "sendMouseReleaseEventSignal"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 12), // "QMouseEvent*"
QT_MOC_LITERAL(4, 48, 5), // "event"
QT_MOC_LITERAL(5, 54, 24) // "sendMouseMoveEventSignal"

    },
    "Track\0sendMouseReleaseEventSignal\0\0"
    "QMouseEvent*\0event\0sendMouseMoveEventSignal"
};
...
void Track::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendMouseReleaseEventSignal((*reinterpret_cast< QMouseEvent*(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Track::*)(QMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Track::sendMouseReleaseEventSignal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Track::*)(QMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Track::sendMouseMoveEventSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Track::sendMouseReleaseEventSignal(QMouseEvent * _t1)
{
...
// SIGNAL 1
void Track::sendMouseMoveEventSignal(QMouseEvent * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
